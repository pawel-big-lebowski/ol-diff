...
public class RunHelperTest {
  ...
  RunHelper helper = new RunHelper(context);
  ...
  void testMergeFacetsCapturesStandardFacets() {
        ...
        .run(
            openLineage
                ...
                .facets(
                    openLineage
                        .newRunFacetsBuilder()
                        .errorMessage(openLineage.newErrorMessageRunFacet(
                            "error1",
                            "error2",
                            "error3"
                        ))
    ...
    assertThat(facets.get("errorMessage").getAdditionalProperties().get("message")).isEqualTo("error1");
  }
