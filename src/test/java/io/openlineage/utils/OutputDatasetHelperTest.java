...
public class OutputDatasetHelperTest {
  ...
  OutputDatasetHelper helper = new OutputDatasetHelper(context);
  ...
  void setup() {
    ...
    OutputDataset output1 = openLineage.newOutputDataset(
        "namespace",
        "o1",
        openLineage
    ...
    OutputDataset output2 = openLineage.newOutputDataset(
        "namespace",
        "o2",
        openLineage
            .newDatasetFacetsBuilder()
        ...
        openLineage
            ...
            .outputStatistics(openLineage.newOutputStatisticsOutputDatasetFacetBuilder().build())
            .put("outputFacet3", openLineage.newOutputStatisticsOutputDatasetFacetBuilder().build())
            .build()
    );

    OutputDataset output3 = openLineage.newOutputDataset(
        "namespace",
        "o3",
