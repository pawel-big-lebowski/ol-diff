...
public class InputDatasetHelperTest {
  ...
  InputDatasetHelper helper = new InputDatasetHelper(context);
  ...
  void setup() {
    ...
    InputDataset input1 = openLineage.newInputDataset(
        "namespace",
        "i1",
        openLineage
    ...
    InputDataset input2 = openLineage.newInputDataset(
        "namespace",
        "i2",
        openLineage
            .newDatasetFacetsBuilder()
    ...
    InputDataset input3 = openLineage.newInputDataset(
        "namespace",
        "i3",
